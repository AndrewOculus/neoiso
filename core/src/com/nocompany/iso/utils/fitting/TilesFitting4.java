...
public class TilesFitting4 extends ApplicationAdapter {
    ...
    public void create() {
        ...
        layer = new Layer( 300, 300, CellType.WATER);
    }
            ...
            for (int i = 0; i < 300; i++) {
                ...
                if( i == selectX && j == selectY){
                    ...
                    if (Gdx.input.isKeyJustPressed(Input.Keys.SPACE)) {
                        if( layer.getTile( j, i) == (short)0 ){
                            layer.setTile( j, i, (short)1 );
                        }else{
                            layer.setTile( j, i, (short)0 );
                        }
                    }
